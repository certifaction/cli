...
Gli utenti possono invitare altre persone a firmare documenti fornendo loro URL sicuri di richiesta di firma, che contengono una chiave segreta. La chiave segreta decrittograferà il documento prima della firma, garantendo che nessuna terza parte (nemmeno <ProductName/>) abbia accesso al documento in testo chiaro.

Le richieste di firma documenti <ProductName/> si basano sull'Archivio Digitale <ProductName/> per archiviare documenti
...
4.  Archivia il documento nell'Archivio Digitale <ProductName/> per il recupero successivo.
