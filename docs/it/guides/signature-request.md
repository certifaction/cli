...
description: Utilizzare Magenta Security Sign per richiedere la firma digitale di documenti altamente confidenziali
---

# Richiesta di Firma

Gli utenti possono invitare altre persone a firmare documenti fornendo loro URL sicuri di richiesta di firma, che contengono una chiave segreta. La chiave segreta decrittograferà il documento prima della firma, garantendo che nessuna terza parte (nemmeno Magenta Security Sign) abbia accesso al documento in testo chiaro.

Le richieste di firma documenti Magenta Security Sign si basano sull'Archivio Digitale Magenta Security Sign per archiviare documenti
...
4.  Archivia il documento nell'Archivio Digitale Magenta Security Sign per il recupero successivo.
