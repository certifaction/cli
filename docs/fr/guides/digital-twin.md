---
title: Jumeau Numérique Magenta Security Sign
description: Utilisez le code QR de chiffrement E2E Magenta Security Sign pour partager et signer des documents hautement confidentiels
---
...
3.  La copie chiffrée est stockée dans l'Archive Numérique <ProductName/> (DA).
4.  L'URL du Jumeau Numérique est enregistrée dans le localisateur de documents <ProductName/>.

<ThemeImage src="document-digital-twin-diagram.png" alt="Diagramme du jumeau numérique de document" />