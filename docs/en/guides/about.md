---
title: What is Magenta Security Sign?
description: Magenta Security Sign the solution to digitally sigh highly confidential documents
---
...
[<ProductName/>](https://telesec.de) is the Privacy-first electronic signature with
...
<ProductName/> supports several signature levels from the standard electronic signature (SES) or the advanced electronic signature (AES) to the qualified electronic signature (QES).
